...
/*onst editClickedForListItem = function (name){
  const editItem = 
...
const handleItemEditClicked = function () {
  $('.js-shopping-list').on('click', '.js-item-edit', event => {
    $('.js-item-edit').change();
    //const id = getItemIdFromElement(event.currentTarget);
    editCheckedForListItem();
    render();
  });
};*/
const editItemOnShoppingList = function (itemName) {
  store.items.push({ id: cuid(), name: itemName, checked: false });
};
...
const handleEditItemClicked = function () {
  $('#js-shopping-list-form').submit(function (event) {
    event.preventDefault();
    const editItemName = $('.js-shopping-list-entry').change();
    $('.js-shopping-list-entry').change('');
    editItemOnShoppingList(editItemName);
    render();
  });
};
/**
